...
- Vector icons fonts registered in `ios/Quizoryx/Info.plist`
...
- Icons not visible:
  - Confirm `UIAppFonts` entries exist in `ios/Quizoryx/Info.plist` for vector icon fonts.
...
## Credits
Original Software Design Document inspiration provided by an AI System Architect; this README reflects the current implementation and concrete plans for Quizoryx.
