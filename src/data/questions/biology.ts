...
export const biologyQuestions: Question[] = [
  ...
  {
    id: 'bio451',
    text: 'What is a cell membrane made of?',
    answers: A('bio451', 'Lipids and proteins', [
      'Only lipids',
      'Only proteins',
      'Only carbohydrates',
    ]),
  ...
  },
  {
    ...
    answers: A('bio452', 'Contains genetic material', [
      'Produces energy',
      'Makes proteins',
      'Stores water',
    ]),
  ...
  },
  {
    ...
    answers: A('bio453', 'Green pigment in plants', [
      'Red pigment',
      'Blue pigment',
      'Yellow pigment',
    ]),
  ...
  {
    id: 'bio454',
    text: 'What is the function of roots?',
    answers: A('bio454', 'Absorb water and nutrients', [
      'Make food',
      'Produce seeds',
      'Attract insects',
    ]),
  ...
  {
    id: 'bio455',
    text: 'What is the function of stems?',
    answers: A('bio455', 'Support and transport', [
      'Make food',
      'Absorb water',
      'Produce seeds',
    ]),
  ...
  },
  {
    ...
    answers: A('bio456', 'Transfer of pollen', [
      'Transfer of water',
  ...
  },
  {
    ...
    answers: A('bio457', 'Seed starting to grow', [
      'Seed dying',
      'Seed sleeping',
      'Seed falling',
    ]),
  ...
  },
  {
    ...
    answers: A('bio458', 'Animal that feeds milk to young', [
  ...
  {
    id: 'bio459',
    text: 'What is a reptile?',
    answers: A('bio459', 'Cold-blooded animal with scales', [
      'Warm-blooded animal',
      'Animal with fur',
      'Animal with feathers',
    ]),
  ...
  {
    id: 'bio460',
    text: 'What is an amphibian?',
    answers: A('bio460', 'Animal living in water and land', [
      'Animal living only in water',
      'Animal living only on land',
      'Animal living in air',
    ]),
    level: 1,
  },
  {
    id: 'bio461',
    text: 'What is warm-blooded?',
    answers: A('bio461', 'Maintains constant body temperature', [
  ...
  {
    id: 'bio462',
    text: 'What is cold-blooded?',
    answers: A('bio462', 'Body temperature matches environment', [
  ...
  },
  {
    id: 'bio463',
    text: 'What is a predator?',
    answers: A('bio463', 'Animal that hunts others', [
      'Animal that is hunted',
      'Plant',
      'Fungus',
    ]),
  ...
  },
  {
    id: 'bio464',
    text: 'What is prey?',
    answers: A('bio464', 'Animal that is hunted', [
      'Animal that hunts',
      'Plant',
      'Fungus',
    ]),
  ...
  },
  {
    id: 'bio465',
    text: 'What is a habitat?',
    answers: A('bio465', 'Where an organism lives', [
      'What an organism eats',
      'How an organism moves',
      'When an organism sleeps',
    ]),
    level: 1,
  },
  {
    id: 'bio466',
    text: 'What is a food chain?',
    answers: A('bio466', 'Energy transfer between organisms', [
      'Type of food',
      'Type of chain',
      'Type of animal',
    ]),
  ...
  },
  {
    ...
    answers: A('bio467', 'Organism that makes its own food', [
      'Organism that eats others',
      'Organism that decomposes',
      'Organism that hunts',
    ]),
  ...
  },
  {
    ...
    answers: A('bio468', 'Organism that eats others', [
      'Organism that makes food',
      'Organism that decomposes',
      'Plant',
    ]),
  ...
  },
  {
    id: 'bio469',
    text: 'What is a decomposer?',
    answers: A('bio469', 'Organism that breaks down dead matter', [
      'Organism that makes food',
      'Organism that hunts',
      'Plant',
    ]),
  ...
  },
  {
    ...
    answers: A('bio470', 'Plants making food from sunlight', [
      'Plants eating other plants',
      'Plants sleeping',
      'Plants moving',
    ]),
    level: 1,
  ...
  {
    id: 'bio471',
    text: 'What is respiration?',
    answers: A('bio471', 'Releasing energy from food', [
      'Making food',
      'Storing food',
      'Eating food',
    ]),
  ...
  },
  {
    ...
    answers: A('bio472', 'Breaking down food', [
      'Making food',
      'Storing food',
      'Cooking food',
    ]),
  ...
  {
    id: 'bio473',
    text: 'What is circulation?',
    answers: A('bio473', 'Blood moving through body', [
      'Food moving through body',
      'Air moving through body',
      'Water moving through body',
    ]),
    level: 1,
  },
  {
    id: 'bio474',
    text: 'What is excretion?',
    answers: A('bio474', 'Removing waste from body', [
      'Adding waste to body',
      'Storing waste',
      'Making waste',
    ]),
    level: 1,
  },
  {
    ...
    answers: A('bio475', 'Making new organisms', [
      'Eating organisms',
      'Killing organisms',
      'Moving organisms',
    ]),
  ...
  // ===== Additional Level 2 Questions (continued) =====
  {
    ...
    answers: A('bio476', 'Reproduction with two parents', [
  ...
  },
  {
    ...
    answers: A('bio477', 'Reproduction with one parent', [
  ...
  {
    id: 'bio478',
    text: 'What is a gamete?',
    answers: A('bio478', 'Sex cell', ['Body cell', 'Blood cell', 'Nerve cell']),
    level: 2,
  },
  {
    id: 'bio479',
    text: 'What is fertilization?',
    answers: A('bio479', 'Sperm joining egg', [
      'Egg dividing',
      'Sperm dividing',
      'Cell dying',
    ]),
  ...
  {
    id: 'bio480',
    text: 'What is an embryo?',
    answers: A('bio480', 'Early stage of development', [
      'Adult stage',
      'Old stage',
      'Dead stage',
    ]),
  ...
  {
    id: 'bio481',
    text: 'What is a fetus?',
    answers: A('bio481', 'Later stage before birth', [
      'Early stage',
      'After birth',
      'Adult',
    ]),
  ...
  {
    id: 'bio482',
    text: 'What is puberty?',
    answers: A('bio482', 'Sexual maturation', ['Birth', 'Death', 'Childhood']),
    level: 2,
  },
  {
    id: 'bio483',
    text: 'What is adolescence?',
    answers: A('bio483', 'Teenage years', [
      'Childhood',
      'Adulthood',
      'Old age',
    ]),
  ...
  },
  {
    id: 'bio484',
    text: 'What is aging?',
    answers: A('bio484', 'Getting older', [
      'Getting younger',
      'Staying same',
      'Growing taller',
    ]),
  ...
  },
  {
    ...
    answers: A('bio486', 'Passing traits to offspring', [
      'Losing traits',
      'Gaining random traits',
      'No traits',
    ]),
    level: 2,
  },
  {
    id: 'bio487',
    text: 'What is a trait?',
    answers: A('bio487', 'Characteristic of organism', [
      'Type of organism',
      'Name of organism',
      'Age of organism',
    ]),
  ...
  },
  {
    id: 'bio488',
    text: 'What is a gene?',
    answers: A('bio488', 'Unit of heredity', [
      'Type of cell',
      'Type of tissue',
      'Type of organ',
    ]),
  ...
  },
  {
    id: 'bio489',
    text: 'What is DNA?',
    answers: A('bio489', 'Genetic material', [
      'Protein',
      'Carbohydrate',
      'Lipid',
    ]),
  ...
  },
  {
    id: 'bio490',
    text: 'What is a chromosome?',
    answers: A('bio490', 'Structure containing DNA', [
      'Type of cell',
      'Type of protein',
      'Type of lipid',
    ]),
  ...
  {
    id: 'bio491',
    text: 'What is a dominant trait?',
    answers: A('bio491', 'Trait that shows when present', [
      'Trait that hides',
      'No trait',
      'Random trait',
    ]),
  ...
  {
    id: 'bio492',
    text: 'What is a recessive trait?',
    answers: A('bio492', 'Trait hidden by dominant', [
  ...
  },
  {
    ...
    answers: A('bio493', 'Differences between organisms', [
      'Similarities',
      'No differences',
      'Random',
    ]),
  ...
  },
  {
    id: 'bio494',
    text: 'What is adaptation?',
    answers: A('bio494', 'Feature helping survival', [
      'Feature hurting survival',
      'No feature',
      'Random feature',
    ]),
    level: 2,
  },
  {
    id: 'bio495',
    text: 'What is evolution?',
    answers: A('bio495', 'Change in species over time', [
      'No change',
      'Sudden change',
      'Random change',
    ]),
  ...
  },
  {
    id: 'bio496',
    text: 'What is natural selection?',
    answers: A('bio496', 'Survival of the fittest', [
      'Random survival',
      'All survive',
      'None survive',
    ]),
  ...
  {
    id: 'bio497',
    text: 'What is a species?',
    answers: A('bio497', 'Group that can interbreed', [
      'Any group',
      'Single organism',
      'No group',
    ]),
  ...
  },
  {
    id: 'bio498',
    text: 'What is extinction?',
    answers: A('bio498', 'Species no longer exists', [
      'Species thriving',
      'Species growing',
      'Species changing',
    ]),
  ...
  },
  {
    id: 'bio499',
    text: 'What is biodiversity?',
    answers: A('bio499', 'Variety of life', [
      'Single species',
      'No life',
      'Same species',
    ]),
  ...
  },
  {
    id: 'bio500',
    text: 'What is an ecosystem?',
    answers: A('bio500', 'Community and its environment', [
      'Single organism',
      'Single species',
      'No organisms',
    ]),
  ...
  // ===== LEVEL 3: More Intermediate Questions =====
  {
    id: 'bio501',
    text: 'What is mitosis?',
    answers: A('bio501', 'Cell division producing identical cells', [
      'Cell division producing different cells',
      'Cell death',
      'Cell growth only',
    ]),
    level: 3,
  },
  {
    id: 'bio502',
    text: 'What is meiosis?',
    answers: A('bio502', 'Cell division producing sex cells', [
  ...
  },
  {
    id: 'bio503',
    text: 'What is DNA?',
    answers: A('bio503', 'Genetic material in cells', [
      'Protein',
      'Carbohydrate',
      'Fat',
    ]),
  ...
  },
  {
    id: 'bio504',
    text: 'What is RNA?',
    answers: A('bio504', 'Molecule that helps make proteins', [
      'Genetic material',
      'Carbohydrate',
      'Fat',
    ]),
  ...
  },
  {
    id: 'bio505',
    text: 'What is a gene?',
    answers: A('bio505', 'Unit of heredity', [
      'Whole chromosome',
      'Cell',
      'Organ',
    ]),
  ...
  },
  {
    id: 'bio506',
    text: 'What is a chromosome?',
    answers: A('bio506', 'Structure containing genes', [
      'Single gene',
      'Cell',
      'Organ',
    ]),
  ...
  },
  {
    id: 'bio507',
    text: 'What is a mutation?',
    answers: A('bio507', 'Change in DNA sequence', [
      'Normal DNA',
      'No change',
      'Cell death',
    ]),
  ...
  {
    id: 'bio508',
    text: 'What is protein synthesis?',
    answers: A('bio508', 'Making proteins from DNA instructions', [
      'Making DNA',
      'Making RNA only',
      'Cell division',
    ]),
  ...
  },
  {
    id: 'bio509',
    text: 'What is transcription?',
    answers: A('bio509', 'Copying DNA to RNA', [
      'Copying RNA to DNA',
      'Making protein',
      'Cell division',
    ]),
  ...
  },
  {
    id: 'bio510',
    text: 'What is translation?',
    answers: A('bio510', 'Making protein from RNA', [
      'Making RNA from DNA',
      'Copying DNA',
      'Cell division',
    ]),
  ...
  },
  {
    id: 'bio511',
    text: 'What is a codon?',
    answers: A('bio511', 'Three-base sequence coding for amino acid', [
      'Single base',
      'Whole gene',
      'Chromosome',
    ]),
  ...
  {
    id: 'bio512',
    text: 'What is an amino acid?',
    answers: A('bio512', 'Building block of proteins', [
      'Building block of DNA',
      'Building block of fat',
      'Building block of sugar',
    ]),
    level: 3,
  },
  {
    id: 'bio513',
    text: 'What is an enzyme?',
    answers: A('bio513', 'Protein that speeds up reactions', [
      'Protein that slows reactions',
      'Carbohydrate',
      'Fat',
    ]),
    level: 3,
  },
  {
    id: 'bio514',
    text: 'What is ATP?',
    answers: A('bio514', 'Energy currency of cells', [
      'Genetic material',
      'Protein',
      'Fat',
    ]),
  ...
  },
  {
    id: 'bio515',
    text: 'What is cellular respiration?',
    answers: A('bio515', 'Breaking down glucose for energy', [
      'Making glucose',
      'Photosynthesis',
      'Cell division',
    ]),
  ...
  },
  {
    id: 'bio516',
    text: 'What is glycolysis?',
    answers: A('bio516', 'Breaking glucose into pyruvate', [
      'Making glucose',
      'Krebs cycle',
      'Electron transport',
    ]),
  ...
  },
  {
    id: 'bio517',
    text: 'What is the Krebs cycle?',
    answers: A('bio517', 'Cycle producing electron carriers', [
      'Glycolysis',
      'Electron transport',
      'Photosynthesis',
    ]),
  ...
  },
  {
    id: 'bio518',
    text: 'What is the electron transport chain?',
    answers: A('bio518', 'Process making most ATP', [
      'Glycolysis',
      'Krebs cycle',
      'Photosynthesis',
    ]),
  ...
  },
  {
    id: 'bio519',
    text: 'What is fermentation?',
    answers: A('bio519', 'Anaerobic energy production', [
      'Aerobic respiration',
      'Photosynthesis',
      'Cell division',
    ]),
  ...
  {
    id: 'bio520',
    text: 'What is aerobic?',
    answers: A('bio520', 'Requiring oxygen', [
      'Without oxygen',
      'With carbon dioxide',
      'With nitrogen',
    ]),
  ...
  {
    id: 'bio521',
    text: 'What is anaerobic?',
    answers: A('bio521', 'Without oxygen', [
      'With oxygen',
      'With carbon dioxide',
      'With nitrogen',
    ]),
  ...
  {
    id: 'bio522',
    text: 'What is the cell cycle?',
    answers: A('bio522', 'Stages of cell life and division', [
      'Single stage',
      'Death only',
      'Growth only',
    ]),
  ...
  {
    id: 'bio523',
    text: 'What is interphase?',
    answers: A('bio523', 'Cell growth and DNA replication phase', [
      'Division phase',
      'Death phase',
      'No activity',
    ]),
  ...
  {
    id: 'bio524',
    text: 'What is cytokinesis?',
    answers: A('bio524', 'Division of cytoplasm', [
      'Division of nucleus',
      'DNA replication',
      'Cell growth',
    ]),
  ...
  },
  {
    id: 'bio525',
    text: 'What is apoptosis?',
    answers: A('bio525', 'Programmed cell death', [
      'Cell division',
      'Cell growth',
      'Random death',
    ]),
