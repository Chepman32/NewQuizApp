...
export const programmingQuestions: Question[] = [
  ...
  { id: 'prg226', text: 'What is a decorator?', answers: A('prg226', 'Function modifying another function', ['Variable', 'Class', 'Loop']), level: 6 },
  { id: 'prg227', text: 'What is a generator?', answers: A('prg227', 'Function yielding values lazily', ['Regular function', 'Variable', 'Class']), level: 6 },
  { id: 'prg228', text: 'What is an iterator?', answers: A('prg228', 'Object for traversing collection', ['Collection itself', 'Single element', 'Function']), level: 5 },
  { id: 'prg229', text: 'What is lazy evaluation?', answers: A('prg229', 'Computing values only when needed', ['Computing all at once', 'No computing', 'Random computing']), level: 6 },
  { id: 'prg230', text: 'What is memoization?', answers: A('prg230', 'Caching function results', ['Recomputing always', 'No caching', 'Random caching']), level: 5 },
  { id: 'prg231', text: 'What is currying?', answers: A('prg231', 'Transforming multi-arg to single-arg functions', ['Combining functions', 'No transformation', 'Random transformation']), level: 7 },
  { id: 'prg232', text: 'What is partial application?', answers: A('prg232', 'Fixing some arguments of function', ['All arguments', 'No arguments', 'Random arguments']), level: 7 },
  { id: 'prg233', text: 'What is immutability?', answers: A('prg233', 'Data that cannot be changed', ['Data that can change', 'No data', 'Random data']), level: 5 },
  { id: 'prg234', text: 'What is pure function?', answers: A('prg234', 'Function with no side effects', ['Function with side effects', 'No function', 'Random function']), level: 6 },
  { id: 'prg235', text: 'What is a side effect?', answers: A('prg235', 'Change outside function scope', ['No change', 'Return value', 'Parameter']), level: 6 },
  { id: 'prg236', text: 'What is functional programming?', answers: A('prg236', 'Programming with pure functions', ['Object-oriented', 'Procedural', 'No paradigm']), level: 5 },
  { id: 'prg237', text: 'What is object-oriented programming?', answers: A('prg237', 'Programming with objects and classes', ['Functional', 'Procedural', 'No paradigm']), level: 4 },
  { id: 'prg238', text: 'What is procedural programming?', answers: A('prg238', 'Programming with procedures', ['Object-oriented', 'Functional', 'No paradigm']), level: 4 },
  { id: 'prg239', text: 'What is declarative programming?', answers: A('prg239', 'Describing what not how', ['Describing how', 'No description', 'Random description']), level: 6 },
  { id: 'prg240', text: 'What is imperative programming?', answers: A('prg240', 'Describing how step by step', ['Describing what', 'No description', 'Random description']), level: 6 },
  { id: 'prg241', text: 'What is dependency injection?', answers: A('prg241', 'Providing dependencies externally', ['Creating internally', 'No dependencies', 'Random dependencies']), level: 6 },
  { id: 'prg242', text: 'What is inversion of control?', answers: A('prg242', 'Framework calls your code', ['You call framework', 'No calling', 'Random calling']), level: 7 },
  { id: 'prg243', text: 'What is SOLID?', answers: A('prg243', 'Object-oriented design principles', ['Programming language', 'Framework', 'Database']), level: 6 },
  { id: 'prg244', text: 'What is DRY?', answers: A('prg244', 'Dont Repeat Yourself principle', ['Repeat everything', 'No principle', 'Random principle']), level: 5 },
  { id: 'prg245', text: 'What is KISS?', answers: A('prg245', 'Keep It Simple Stupid principle', ['Make it complex', 'No principle', 'Random principle']), level: 5 },
  { id: 'prg246', text: 'What is YAGNI?', answers: A('prg246', 'You Arent Gonna Need It', ['Build everything', 'No principle', 'Random principle']), level: 6 },
  { id: 'prg247', text: 'What is refactoring?', answers: A('prg247', 'Improving code without changing behavior', ['Changing behavior', 'Deleting code', 'No change']), level: 5 },
  { id: 'prg248', text: 'What is code smell?', answers: A('prg248', 'Indicator of potential problem', ['Good code', 'No indicator', 'Random indicator']), level: 6 },
  { id: 'prg249', text: 'What is technical debt?', answers: A('prg249', 'Cost of shortcuts in code', ['Good practice', 'No cost', 'Random cost']), level: 6 },
  { id: 'prg250', text: 'What is pair programming?', answers: A('prg250', 'Two programmers working together', ['Solo programming', 'No programming', 'Random programming']), level: 5 },
];
