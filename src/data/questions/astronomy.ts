...
export const astronomyQuestions: Question[] = [
  ...
  { id: 'ast226', text: 'What is redshift?', answers: A('ast226', 'Light stretched to longer wavelengths', ['Shorter wavelengths', 'No change', 'Random change']), level: 4 },
  { id: 'ast227', text: 'What is blueshift?', answers: A('ast227', 'Light compressed to shorter wavelengths', ['Longer wavelengths', 'No change', 'Random change']), level: 4 },
  { id: 'ast228', text: 'What is the Doppler effect?', answers: A('ast228', 'Change in wavelength due to motion', ['No change', 'Random change', 'Color change only']), level: 4 },
  { id: 'ast229', text: 'What is a protostar?', answers: A('ast229', 'Star in early formation', ['Dying star', 'Stable star', 'Dead star']), level: 4 },
  { id: 'ast230', text: 'What is stellar nucleosynthesis?', answers: A('ast230', 'Element creation in stars', ['Element destruction', 'No elements', 'Random elements']), level: 5 },
  { id: 'ast231', text: 'What is the main sequence?', answers: A('ast231', 'Stage where stars fuse hydrogen', ['Dying stage', 'Birth stage', 'No stage']), level: 4 },
  { id: 'ast232', text: 'What is a planetary nebula?', answers: A('ast232', 'Gas expelled by dying star', ['Forming star', 'Planet', 'Galaxy']), level: 5 },
  { id: 'ast233', text: 'What is the event horizon?', answers: A('ast233', 'Boundary of black hole', ['Center of black hole', 'Outside black hole', 'No boundary']), level: 5 },
  { id: 'ast234', text: 'What is Hawking radiation?', answers: A('ast234', 'Radiation from black holes', ['Radiation from stars', 'No radiation', 'Random radiation']), level: 6 },
  { id: 'ast235', text: 'What is a singularity?', answers: A('ast235', 'Point of infinite density', ['Normal density', 'No density', 'Low density']), level: 6 },
  { id: 'ast236', text: 'What is the Chandrasekhar limit?', answers: A('ast236', 'Maximum mass of white dwarf', ['Minimum mass', 'Average mass', 'No limit']), level: 6 },
  { id: 'ast237', text: 'What is the Schwarzschild radius?', answers: A('ast237', 'Radius of event horizon', ['Radius of star', 'Radius of planet', 'No radius']), level: 7 },
  { id: 'ast238', text: 'What is gravitational lensing?', answers: A('ast238', 'Light bent by gravity', ['Light absorbed', 'Light reflected', 'No effect']), level: 5 },
  { id: 'ast239', text: 'What is cosmic microwave background?', answers: A('ast239', 'Radiation from early universe', ['Recent radiation', 'No radiation', 'Star radiation']), level: 5 },
  { id: 'ast240', text: 'What is the Hubble constant?', answers: A('ast240', 'Rate of universe expansion', ['Rate of contraction', 'No rate', 'Random rate']), level: 6 },
  { id: 'ast241', text: 'What is a parsec?', answers: A('ast241', 'Unit of distance (3.26 light years)', ['Unit of time', 'Unit of mass', 'Unit of temperature']), level: 4 },
  { id: 'ast242', text: 'What is parallax?', answers: A('ast242', 'Apparent shift due to viewing angle', ['No shift', 'Random shift', 'Color shift']), level: 5 },
  { id: 'ast243', text: 'What is apparent magnitude?', answers: A('ast243', 'Brightness as seen from Earth', ['Actual brightness', 'No brightness', 'Random brightness']), level: 5 },
  { id: 'ast244', text: 'What is absolute magnitude?', answers: A('ast244', 'Brightness at standard distance', ['Brightness from Earth', 'No brightness', 'Random brightness']), level: 5 },
  { id: 'ast245', text: 'What is a Cepheid variable?', answers: A('ast245', 'Star with regular brightness changes', ['Constant star', 'Dead star', 'Planet']), level: 6 },
  { id: 'ast246', text: 'What is a Type Ia supernova?', answers: A('ast246', 'White dwarf explosion', ['Massive star explosion', 'No explosion', 'Planet explosion']), level: 6 },
  { id: 'ast247', text: 'What is a gamma-ray burst?', answers: A('ast247', 'Extremely energetic explosion', ['Low energy event', 'No energy', 'Random event']), level: 6 },
  { id: 'ast248', text: 'What is a magnetar?', answers: A('ast248', 'Neutron star with extreme magnetic field', ['Normal star', 'Planet', 'Moon']), level: 7 },
  { id: 'ast249', text: 'What is the Hertzsprung-Russell diagram?', answers: A('ast249', 'Plot of star luminosity vs temperature', ['Plot of planets', 'Plot of galaxies', 'No plot']), level: 6 },
  { id: 'ast250', text: 'What is the Roche limit?', answers: A('ast250', 'Distance where tidal forces destroy object', ['Safe distance', 'No limit', 'Random distance']), level: 7 },
];
