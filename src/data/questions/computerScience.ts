...
export const computerScienceQuestions: Question[] = [
  ...
  // ===== LEVEL 6-8: More Advanced Questions =====
  {
    ...
    answers: A('cs226', 'Malware that encrypts files for ransom', [
      'Helpful software',
      'Antivirus',
      'Firewall',
    ]),
  ...
  },
  {
    ...
    answers: A('cs227', 'Security using two verification methods', [
      'Single password',
      'No security',
      'Random security',
    ]),
  ...
  },
  {
    id: 'cs228',
    text: 'What is a VPN?',
    answers: A('cs228', 'Virtual Private Network', [
      'Physical network',
      'Public network',
      'No network',
    ]),
  ...
  },
  {
    id: 'cs229',
    text: 'What is SSH?',
    answers: A('cs229', 'Secure Shell protocol', [
      'Insecure protocol',
      'No protocol',
      'Random protocol',
    ]),
  ...
  },
  {
    id: 'cs230',
    text: 'What is FTP?',
    answers: A('cs230', 'File Transfer Protocol', [
      'Email protocol',
      'Web protocol',
      'No protocol',
    ]),
  ...
  },
  {
    id: 'cs231',
    text: 'What is DNS?',
    answers: A('cs231', 'Domain Name System', [
      'File system',
      'Operating system',
      'No system',
    ]),
  ...
  },
  {
    id: 'cs232',
    text: 'What is TCP/IP?',
    answers: A('cs232', 'Internet communication protocols', [
      'Single protocol',
      'No protocol',
      'Random protocol',
    ]),
  ...
  },
  {
    ...
    answers: A('cs233', 'Device directing network traffic', [
      'Computer',
      'Monitor',
      'Keyboard',
    ]),
  ...
  {
    id: 'cs234',
    text: 'What is a switch?',
    answers: A('cs234', 'Device connecting network devices', [
      'Router',
      'Computer',
      'Monitor',
    ]),
  ...
  },
  {
    ...
    answers: A('cs235', 'Data transfer capacity', [
      'Physical width',
      'Height',
      'Weight',
    ]),
  ...
  },
  {
    ...
    answers: A('cs236', 'Delay in data transfer', [
      'Speed',
      'Bandwidth',
      'No delay',
    ]),
  ...
  },
  {
    ...
    answers: A('cs237', 'Unit of data in network', [
      'Physical package',
      'File',
      'Program',
    ]),
  ...
  },
  {
    id: 'cs238',
    text: 'What is a protocol?',
    answers: A('cs238', 'Rules for communication', [
      'Random rules',
      'No rules',
      'Physical rules',
    ]),
  ...
  },
  {
    ...
    answers: A('cs239', 'Software with public source code', [
      'Closed source',
      'No source',
      'Random source',
    ]),
  ...
  },
  {
    ...
    answers: A('cs240', 'Tracking changes to code', [
      'No tracking',
      'Random changes',
      'Deleting code',
    ]),
  ...
  },
  {
    id: 'cs241',
    text: 'What is Git?',
    answers: A('cs241', 'Version control system', [
      'Programming language',
      'Operating system',
      'Database',
    ]),
  ...
  },
  {
    ...
    answers: A('cs242', 'Storage for code and history', [
      'Single file',
      'No storage',
      'Random storage',
    ]),
  ...
  },
  {
    ...
    answers: A('cs243', 'Saved change in version control', [
      'Deleted change',
      'No change',
      'Random change',
    ]),
  ...
  },
  {
    ...
    answers: A('cs244', 'Parallel version of code', [
      'Single version',
      'No version',
      'Random version',
    ]),
  ...
  },
  {
    ...
    answers: A('cs245', 'Combining code branches', [
      'Separating code',
      'Deleting code',
      'No action',
    ]),
  ...
  },
  {
    id: 'cs246',
    text: 'What is CI/CD?',
    answers: A('cs246', 'Continuous Integration/Deployment', [
      'Manual deployment',
      'No deployment',
      'Random deployment',
    ]),
  ...
  },
  {
    id: 'cs247',
    text: 'What is DevOps?',
    answers: A('cs247', 'Development and operations practices', [
      'Only development',
      'Only operations',
      'No practices',
    ]),
  ...
  },
  {
    id: 'cs248',
    text: 'What is agile?',
    answers: A('cs248', 'Iterative development methodology', [
      'Waterfall',
      'No methodology',
      'Random methodology',
    ]),
  ...
  },
  {
    id: 'cs249',
    text: 'What is scrum?',
    answers: A('cs249', 'Agile framework with sprints', [
      'Waterfall',
      'No framework',
      'Random framework',
    ]),
  ...
  },
  {
    ...
    answers: A('cs250', 'Short development cycle', [
      'Long cycle',
      'No cycle',
      'Random cycle',
    ]),
